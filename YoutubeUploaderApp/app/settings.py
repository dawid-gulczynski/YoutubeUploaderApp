"""
Django settings for YoutubeUploaderApp project.
...
SECRET_KEY = 'django-insecure-s9q4(i8m_s80t7zk+a)94wvzmgnc4p)1b)i(!%df77o#n@njh%'
...
LOGOUT_REDIRECT_URL = 'uploader:login'

# Google OAuth Settings (uzupełnij danymi z Google Cloud Console)
